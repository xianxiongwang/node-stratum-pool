...
var StratumClient = function(options){
    ...
    this.initLastActivity = this.lastActivity;
    ...
    this.sendMiningJob = function(jobParams){
        ...
        //刚上线的机器-10S钟没有提及share,难度快速下降
        if(_this.lastActivity==_this.initLastActivity && lastActivityAgo>10 * 1000){
            var targetDiff = _this.difficulty*0.2; ///90 * (60 * 0.9);
            //不能太小
            // if(targetDiff<_this.difficulty*0.5){
            //      targetDiff = _this.difficulty*0.5;
            //  }
            ...
            _this.sendDifficulty(parseFloat(targetDiff.toFixed(8)));

        }else if (lastActivityAgo > 90 * 1000){//90s没有提交数据减少难度
           var targetDiff = _this.difficulty*0.6; ///90 * (60 * 0.9);
            //不能太小
            // if(targetDiff<_this.difficulty*0.5){
            //      targetDiff = _this.difficulty*0.5;
            //  }
