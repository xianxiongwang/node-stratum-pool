...
var JobManager = module.exports = function JobManager(options) {
    ...
    this.processShare = function (jobId, previousDifficulty, difficulty, extraNonce1, extraNonce2, nTime, nonce, ipAddress, port, workerName, soln) {
        ...
        // wxx.modify 
        var headerStr = extraNonce1.toLowerCase()+extraNonce2.toLowerCase()+nTime;
        if (!job.registerSubmit(headerStr, soln)) {
        ...
        //console.log('rewardFees: ' + job.rpcData.rewardFees);
        //console.log('coinbaseReward: ' + job.coinbaseReward);
        ...
        console.log('height: ' + job.rpcData.height +  ' blockDiff: ' + blockDiffAdjusted +  ' worker: ' + workerName +     ' shareDiff: ' + shareDiff.toFixed(8));        
        ...
        _this.emit('share', {
            ...
            coinbaseReward:job.coinbaseReward,
            difficulty: difficulty,
