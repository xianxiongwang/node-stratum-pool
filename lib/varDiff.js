...
var varDiff = module.exports = function varDiff(port, varDiffOptions) {
    ...
    this.manageClient = function (client) {
        ...
        client.on('submit', function () {
            ...
            var ddiff = diffAvg/avg * options.targetTime/client.difficulty;
            //var ddiff = options.targetTime / avg;

            console.error("Difficulty update:avg="+avg+" diffAvg="+diffAvg+" ddiff="+ddiff +" targetTime="+options.targetTime);
            ...
            if (avg > tMax && client.difficulty > options.minDiff) {
                ...
                console.error("Difficulty update: no update avg="+avg+" tmin="+tMin+ " tMax="+tMax);
